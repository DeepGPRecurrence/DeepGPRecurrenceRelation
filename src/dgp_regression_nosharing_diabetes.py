...
def compute_EZ_trajectory(K, m, sigma2s, lengthscales):
    def recur(x, sigma2, lengthscale):
        return 2 * (1. - 1. / np.power(1 + x / lengthscale ** 2, 0.5 * m))
...
# # save dir
save_dir = "../data/dgp_regression_models_diabetes"
...
selected_dim= 2
save_file = "../figure/experiment_diabetes/no_sharing/m_{}_dgp.png".format(selected_dim)
