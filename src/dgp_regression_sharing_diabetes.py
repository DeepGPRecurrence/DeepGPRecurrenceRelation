...
## save dir
save_dir = "../data/dgp_regression_models_share_kernel_diabetes"
dims = [2, 3, 4, 5, 6, 7, 8, 9, 20]
n_layers = [2, 3, 4, 5, 6]
...
selected_dim= 20
save_file = "../figure/experiment_diabetes/sharing/m_{}_dgp.png".format(selected_dim)
